...
1. 25-05-23： 基于 redis7 完善；
   1. TODO 整理对象系统，把数据结构章节重新整理一下；
2. 23-11-24： 创建文档骨架，确定知识体系；2. 完成《概述》《对象系统》等篇；3. 完成《持久化》篇章；

3. redis 版本及下载地址： [redis-7.0.15](https://redis.io/downloads/)
4. 视频资料[在这](https://www.bilibili.com/video/BV13R4y1v7sP)
5. 笔记资料[在这](https://github.com/Romantic-Lei/Learning-in-practice/tree/master/Redis)

## [对象系统](./ch02-datatype.md)

> 1. 为什么设计对象系统
> 2. 如何实现命令的多态
> 3. 内建对象有哪些
> 4. 值对象支持哪些数据类型，分别有哪些常用命令和分别有哪些业务场景
> 5. 值对象底层有哪些数据结构，转换条件是怎样的，如何高效利用这些转换条件

## [高级特性](./ch03-greatfeature.md)
