import{_ as e,W as p,X as o,Y as n,Z as l,$ as t,a0 as s,C as r}from"./framework-16b96b76.js";const c="/assets/1700127016519-40ba8de0.png",i="/assets/1712505273400-14c422d0.png",u="/assets/1701349640431-d33fee05.png",d="/assets/1701351392833-a4d32e81.png",v="/assets/1700537997473-ee9d7966.png",k="/assets/1701350337023-0629cc82.png",m="/assets/1701350532636-1b56c28e.png",b="/assets/1701350600893-e3a73c8c.png",L="/assets/1701351163555-c7d6a2f7.png",g="/assets/1699920519563-47b0af44.png",E="/assets/1699920524572-a4400a14.png",A="/assets/1699920529256-deeca5fd.png",T={},N=s(`<h1 id="_4-线程及线程池" tabindex="-1"><a class="header-anchor" href="#_4-线程及线程池" aria-hidden="true">#</a> 4. 线程及线程池</h1><blockquote><ol><li>线程与进程</li><li>Java 中创建线程的方法</li><li>线程的状态转换【或生命周期】，Object 中的方法、Condition 类中的方法、LockSupport 的方法</li><li>池化技术理论基础</li><li>Java 中的两种创建线程池的方法、线程池原理、线程池实践经验</li><li>Spring 框架中使用线程池</li></ol></blockquote><blockquote><p>线程的创建方式 线程源码介绍 线程的生命周期及状态转化 线程的调度 线程间的互斥、同步、协作</p></blockquote><ol><li>进程与线程；</li><li>Java 中线程的创建与使用；</li><li>线程的 API；</li><li>线程的状态转化；</li></ol><details class="hint-container details"><summary>Thread 类的字节码</summary><div class="language-log line-numbers-mode" data-ext="log"><pre class="language-log"><code>
