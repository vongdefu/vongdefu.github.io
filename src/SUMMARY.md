...
- [设计模式](./01-csbase/designPattern/README.md)
  - [单例模式](./01-csbase/designPattern/01-ch01-singleton.md)
  - [建造模式](./01-csbase/designPattern/02-ch02-build.md)
  - [模板方法模式](./01-csbase/designPattern/03-ch03-template-method.md)
  - [策略模式](./01-csbase/designPattern/04-ch04-strategy.md)
  - [责任链模式](./01-csbase/designPattern/05-ch05-responsibility-chain.md)
